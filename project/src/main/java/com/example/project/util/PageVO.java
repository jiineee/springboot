...
public class PageVO {
	...
	public PageVO(Criteria cri, int total) {
		...
		//this.end = (int)(Math.ceil( 현재 조회하는 페이지 / 페이지네이션 개수 ) ) * 페이지네이션 개수;
		...
		//end페이지 재결정
		//데이터가 25개 -> end = 10, realEnd = 3 (실제 끝번호를 따라감)
		//데이터가 153개 -> end = 20; realEnd = 16 (실제 끝번호를 따라감)
		...
		//next활성화 여부
		//end = 10, realEnd = 16 이라고 할 때 다음 버튼이 있다는 의미
